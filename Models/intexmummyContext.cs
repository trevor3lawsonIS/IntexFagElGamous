...
{
    public partial class intexmummyContext : DbContext
    {
        ...
        public virtual DbSet<C14result> C14results { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bodyanalysis>(entity =>
            {
                ...
                entity.Property(e => e.EastWest).HasColumnType("char");
                ...
                entity.Property(e => e.NorthSouth).HasColumnType("char");
                ...
                entity.Property(e => e.Osteaophytosis).HasColumnType("character varying");
                ...
                entity.Property(e => e.SupraorbitalRiges).HasColumnType("character varying");
            ...
            modelBuilder.Entity<C14result>(entity =>
            {
                entity.HasKey(e => e.Sample)
                    .HasName("c14results_pkey");

                entity.ToTable("c14results");

                entity.Property(e => e.AgeBp).HasColumnName("AgeBP");

                entity.Property(e => e.Area).HasColumnType("character varying");

                entity.Property(e => e.CalendarDate).HasColumnType("character varying");
